...
class SlackProviderTest extends TestCase
{
    ...
    /** @test */
    public function it_can_not_instantiate_the_slack_provider_when_required_options_are_missing()
    {
    ...
    /** @test */
    public function it_can_retrieve_the_autorized_user_test_url()
    {
        // When
        $provider = new SlackProvider([
            'clientId' => 'xx',
    ...
    /** @test */
    public function it_can_retrieve_the_base_access_token_url()
    {
        // When
        $provider = new SlackProvider([
            'clientId' => 'xx',
